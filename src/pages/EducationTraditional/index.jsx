            ...
            <div className='space-y-6 text-justify'>
              <div id='ytetutam'>
                ...
                <p>
                  ...
                  lượng chăm sóc và kết quả điều trị sẽ được cải thiện đáng kể,
                  từ đó nâng cao và cải thiện trình độ sức khỏe của cộng đồng
                  lên một tầm cao mới. Đây không chỉ là việc chữa bệnh mà còn là
                  chăm sóc toàn diện với sự đồng cảm.
                </p>
              </div>
              ...
              <div id='dieutritutam'>
                ...
                <p>
                  ...
                  phát từ lòng nhân ái, sự thấu hiểu và trách nhiệm của người
                  thầy thuốc ("Từ Tâm"). Khi đó, đạo đức nghề nghiệp của ngành y
                  tế (Y Đức) sẽ được nâng cao, thể hiện sự tôn trọng và coi
                  trọng bệnh nhân.
                </p>
              </div>
            </div>
            ...
            <div className='space-y-6 text-justify'>
              <div id='chamsoctutam'>
                ...
                <p>
                  ...
                  chân thành ("Từ Tâm") sẽ mang lại giá trị to lớn. Giá trị ở
                  đây không chỉ là sự hài lòng của người bệnh, mà còn là sự tin
                  tưởng, niềm hy vọng và sự an ủi, từ đó nâng cao ý nghĩa và
                  hiệu quả của mọi hành động chăm sóc.
                </p>
              </div>
              ...
              <div id='congdongtutam'>
                ...
                <p>
                  ...
                  những điều tốt đẹp, những giá trị nhân văn sẽ được phổ biến
                  rộng rãi hơn, lan tỏa mạnh mẽ hơn trong xã hội. Điều này tạo
                  nên một môi trường sống tích cực và đầy yêu thương.
                </p>
              </div>
            </div>
          </div>
