      ...
      <div className='px-6 lg:px-20 my-8 space-y-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div>
            ...
            ("Từ Tâm") sẽ mang lại giá trị to lớn. Giá trị ở đây không chỉ là sự
            hài lòng của người bệnh, mà còn là sự tin tưởng, niềm hy vọng và sự
            an ủi, từ đó nâng cao ý nghĩa và hiệu quả của mọi hành động chăm
            sóc.
          </div>
