      ...
      <div className='px-6 lg:px-20 my-8 space-y-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div>
            ...
            lòng, sự tận tâm và lòng trắc ẩn ("Từ Tâm"), thì chất lượng chăm sóc
            và kết quả điều trị sẽ được cải thiện đáng kể, từ đó nâng cao và cải
            thiện trình độ sức khỏe của cộng đồng lên một tầm cao mới. Đây không
            chỉ là việc chữa bệnh mà còn là chăm sóc toàn diện với sự đồng cảm.
          </div>
