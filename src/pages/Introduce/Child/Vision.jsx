    ...
    <div className='px-6 lg:px-20 my-8 space-y-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
        <div className='text-justify'>
          ...
          <strong>gngay gần nhà</strong>, được đồng hành trọn đời bởi đội ngũ
          bác sĩ tận tâm và công nghệ hiện đại. Với nền tảng là{' '}
          <strong>Tập đoàn Y khoa Quốc tế Từ Tâm</strong>, chúng tôi không ngừng
          mở rộng mạng lưới phòng khám - nhà thuốc “Gần Đây” khắp các khu dân
          cư, đô thị và vùng ven, từng bước hiện thực hóa giấc mơ{' '}
