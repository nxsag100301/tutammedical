  ...
  return (
    <div className='px-6 lg:px-20 my-10 space-y-10'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 items-start'>
        <div className='space-y-6 text-justify'>
          <div id='tutamkhoiy' className='space-y-4'>
            ...
            <p>
              ...gói trọn triết lý sâu sắc và là kim chỉ nam tuyệt vời cho một
              dự án trong ngành y tế. Nó không chỉ là một khẩu hiệu, mà là một
              cam kết về giá trị cốt lõi mà Tập đoàn Y khoa Quốc tế Từ Tâm hướng
              tới. Đây là một triết lý mạnh mẽ, mang ý nghĩa rất lớn đối với cả
              hành trình xây dựng doanh nghiệp và sức khỏe cộng đồng mà Người
              sáng lập muốn tạo ra.
            </p>
            <p>
              Câu nói{' '}
              ...
              không chỉ là triết lý, mà còn là lời hứa, là cam kết của Tập đoàn
              Y khoa Quốc tế Từ Tâm với chính mình, với đội ngũ và với cộng
              đồng. Chính "Cái Tâm" này sẽ là ngọn hải đăng dẫn lối cho Tập đoàn
              và Người sáng lập vượt qua mọi thử thách, xây dựng một đế chế y tế
              không chỉ hùng mạnh về quy mô mà còn vĩ đại về giá trị nhân văn.
            </p>
          </div>
        </div>
      ...
      <div>
        ...
        <p>
          <strong>Đạo đức và Y đức làm nền tảng:</strong> Ngành y tế khác với
          các ngành kinh doanh thông thường. Khởi ý từ "tâm" nghĩa là xuất phát
          điểm của mọi dự án, mọi dịch vụ đều phải đặt lợi ích, sức khỏe và sự
          an toàn của bệnh nhân lên hàng đầu. Đây là yếu tố then chốt để xây
          dựng niềm tin - tài sản quý giá nhất trong y tế.
        </p>
        <p>
          <strong>Giá trị cộng đồng:</strong> Ý tưởng về một hệ thống y tế "GẦN
          ĐÂY" tiện lợi, cá nhân hóa, và một Trung tâm Đa khoa hàng đầu xuất
          phát từ mong muốn thực sự cải thiện chất lượng sống và tiếp cận dịch
          vụ y tế cho mọi người dân. Nó không chỉ là về lợi nhuận, mà còn là về
          một sứ mệnh cao cả hơn.
        </p>
      </div>
        ...
        <div className='space-y-6 text-justify'>
          <div id='tutamthuchien'>
            ...
            <p>
              ...
              dựng một tập đoàn y tế lớn, đặc biệt là vươn ra quốc tế, sẽ gặp vô
              vàn khó khăn. "Từ tâm mà thực hiện" nghĩa là giữ vững niềm tin,
              không ngừng học hỏi, thích nghi và kiên trì theo đuổi mục tiêu,
              ngay cả khi đối mặt với áp lực.
            </p>
            <p>
