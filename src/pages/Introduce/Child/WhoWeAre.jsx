        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
          <div className='text-justify space-y-2'>
            <div>
              ...
              Quốc tế sáng lập nên dự án này, mà còn là kim chỉ nam cho mọi hoạt
              động của chúng tôi. Với tâm niệm “làm y bằng cái tâm trong sáng”,
              chúng tôi kiến tạo mô hình phòng khám chuyên khoa{' '}
            ...
            <div>
              ...
              cần phải chờ đợi lâu, không cần đi xa, bệnh nhân vẫn nhận được sự
              chăm sóc toàn diện, lâu dài và mang tính cá nhân hóa, dưới sự đồng
              hành của đội ngũ y bác sĩ tận tâm và công nghệ hỗ trợ hiện đại.
            </div>
            <div>
