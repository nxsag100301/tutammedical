              ...
              <div>
                <ul className='list-disc pl-4'>
                  ...
                  <li>
                    ...
                    gũi, giúp mọi người được chăm sóc y tế chất lượng ngay nơi
                    họ sống và làm việc.
                  </li>
                </ul>
              </div>
              <div>
                Chúng tôi tin rằng sự <strong>thấu hiểu và gần gũi</strong> là
                nền tảng để tạo nên một dịch vụ y tế nhân bản, bền vững và đáng
                tin cậy.
              </div>
            </div>
