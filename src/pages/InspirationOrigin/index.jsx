      ...
      <div className='px-6 lg:px-20 my-10 space-y-10'>
          ...
          <div className='space-y-6 text-justify'>
            <div id='tutamkhoiy' className='space-y-4'>
              ...
              <p>
                ...
                cam kết về giá trị cốt lõi mà Tập đoàn Y khoa Quốc tế Từ Tâm
                hướng tới. Đây là một triết lý mạnh mẽ, mang ý nghĩa rất lớn đối
                với cả hành trình xây dựng doanh nghiệp và sức khỏe cộng đồng mà
                Người sáng lập muốn tạo ra.
              </p>
              <p>
                Câu nói{' '}
                ...
                Tập đoàn và Người sáng lập vượt qua mọi thử thách, xây dựng một
                đế chế y tế không chỉ hùng mạnh về quy mô mà còn vĩ đại về giá
                trị nhân văn.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <p>
            ...
            các ngành kinh doanh thông thường. Khởi ý từ "tâm" nghĩa là xuất
            phát điểm của mọi dự án, mọi dịch vụ đều phải đặt lợi ích, sức khỏe
            và sự an toàn của bệnh nhân lên hàng đầu. Đây là yếu tố then chốt để
            xây dựng niềm tin - tài sản quý giá nhất trong y tế.
          </p>
          <p>
            ...
            xuất phát từ mong muốn thực sự cải thiện chất lượng sống và tiếp cận
            dịch vụ y tế cho mọi người dân. Nó không chỉ là về lợi nhuận, mà còn
            là về một sứ mệnh cao cả hơn.
          </p>
        </div>
          ...
          <div className='space-y-6 text-justify'>
            ...
            <div id='tutamthanhtuu'>
              ...
              <p>
                ...
                nhất chính là sự tin tưởng của bệnh nhân, sức khỏe được cải
                thiện của cộng đồng, và sự phát triển bền vững của một hệ thống
                y tế thực sự chất lượng.
              </p>
              <p>
              ...
              <p>
                ...
                tư có cùng tầm nhìn, mong muốn đóng góp vào một điều lớn lao hơn
                là chỉ lợi nhuận.
              </p>
            </div>
          </div>
